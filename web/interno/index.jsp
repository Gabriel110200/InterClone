            ...
            <div class="dashboard-container">
                ...
                <div class="buttons-container">
                    <div class="row">
                        ...
                        <div class="col-4">
                            <button class="dashboard-button" id="newUser" >Cadastrar Usuários</button>
                        </div>
                        <div class="col-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <button class="dashboard-button" id="showUser" >Listar Usuários</button>
                        </div>
                        <div class="col-4">
                ...
                <a href="/InterClone">Voltar para a página Iniciall</a>
            </div>
        </div>
